                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="exampleFormControlInput1" type="file" required name="people_photo">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input class="form-control" name="position_uz" id="position_uz" type="text" placeholder="..." value="">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label" for="position_ru">Позиция Ru</label>
                                <input class="form-control" name="position_ru" id="position_ru" type="text" placeholder="..." value="">
                            </div>
                            <div class="col-md-4 mb-3">
                                <label class="form-label" for="position_en">Позиция En</label>
                                <div class="input-group">
                                    <input class="form-control" name="position_en" id="position_en" type="text" placeholder="..." aria-describedby="inputGroupPrepend2" value="">
                                </div>
                            </div>
                        </div>
                        <div class="row">
