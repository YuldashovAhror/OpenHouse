...
<path d="M18.3569 18.357L12.2192 12.2193" stroke="#323232" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    ...
    <div class="popup__container" style="display: ">
        <h2 class="popup__title general-lackR">ОСТАВЬТЕ ЗАЯВКУ</h2>
        <!-- /.popup__title general-lackR -->
        <form action="" class="popup__form">
            <input type="text" placeholder="имя">
            <input type="text" name="phone" type="tel" class="form__tel" required placeholder="+998"
                   pattern="^[0-9-+\s()]*$">
            <button type="submit" class="general-lackR">оставить заявку</button>
        </form>
        <!-- /.popup__form -->
        <p class="popup__txt general-lackR">Нажимая кнопку «Отправить», Вы подтверждаете свое согласие на обработку персональных данных</p>
        <!-- /.popup__txt -->
    </div>
    {{--=========POPUP SUCCESS=========--}}
